<?php include_once 'sections/t_inicio.php';?>
  ...
  <!-- Autores Lista -->
        <div class="viewasesor"></div>
        <!---Modal Editar---->
      <div class="modal" tabindex="-1" id="modal-editas">
                ...
                <div class="row align-items-center">
                  ...
                  <form id="form_edit_autor" class="row">
                    ...
                    <div class="col-lg-8 text-left mb-3">
                      <input class="form-control text-left bg-input" id="emaAutor" type="text" name="ocu">
                      <small class="modal-title">PROFESION</small>
                    </div>
