        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3 rounded" style="background-color:#1A2332;">
              <div class="row" >
                <form id="autoresUpload" class="row mx-2">
                  <h3 class="pb-2" style="font-size:25px; color:#fff;">Registrar Autor</h3>
                  <p style="font-size:11px; color:#9FEF00; letter-spacing:2px; font-weight:600;">DATOS DEL NUEVOS AUTOR</p>
