<?php include_once 'sections/t_inicio.php';?>
  ...
  <!-- Autores Lista -->
        <?php
          $sql = 'SELECT nomAsesor,apeAsesor,ocupacion FROM asesor';
            ...
            <?php while ($autor = $consulta->fetch_assoc()): ?>
              <div class=" col-md-3 text-left">
                <div class="rounded d-flex flex-row align-items-center mb-4 shadow" style="background-color:#1A2332;">
                  ...
                  <div class="mx-2">
                    <p style="font-size:12px; color:#FFF; font-weight: bold;"><?php echo $autor['nomAsesor'] . ' ' . $autor['apeAsesor'] ?></br>
                    <span style="font-size:11px; color:#A4B1CD; font-weight: 500;"><?php echo $autor['ocupacion']?></span></p>
