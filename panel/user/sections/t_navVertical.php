    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="" navbar-scroll="true" style="background-color:#111927;">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0" style="color:#fff;">Panel Prinipal</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav justify-content-end">
            <div style="background-color:#1A2332; border-radius:7px;display: flex; align-items: center;margin-right:8px; margin-left:8px; justify-content: center; padding-left:11px">
              <button class="d-flex justify-content-center align-items-center" style="background-color: transparent; border:0px;" data-bs-toggle="modal" data-bs-target="#subir" href="#">
                <svg class="" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20"><path d="M450-313v-371L330-564l-43-43 193-193 193 193-43 43-120-120v371h-60ZM220-160q-24 0-42-18t-18-42v-143h60v143h520v-143h60v143q0 24-18 42t-42 18H220Z" fill="#A4B1CD"/></svg>
                <li class="nav-item d-flex align-items-center">
                  <span class=" mb-0 me-3" style="font-size:11px; text-transform: uppercase; font-weight:400; letter-spacing:1px; color:#A4B1CD;">Subir Proyecto</span>
                </li>
              </button>
              <div class="modal" tabindex="-1" id="subir">
                <div class="modal-dialog">
                  <div class="modal-content" style="background-color:#1A2332;">
                    <div class="modal-body">
                      <div class="row align-items-center">
                        <div class="row mb-2" style="">
                          <h5 class="modal-title text-center my-4" style="color:#FFF; font-size:20px; letter-spacing:1px;">Proximamente podras registrar tu Proyecto o tu Tesis</h5>
                        </div>
