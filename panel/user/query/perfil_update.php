<?php
    ...
    if(empty($_SESSION['codUsu'])){
        ...
        $sql = "UPDATE usuario SET nomUsu='".$nom."',appUsu='".$app."',apmUsu='".$apm."',dniUsu='".$dni."',emailUsu='".$ema."',celUsu='".$cel."',sexUsu='".$sex."',fnacUsu='".$fna."' WHERE codUsu='".$codUsu."'";
                ...
                if($filesizeImagen < 1){ // el archivo está vacío
                    ...
                    if(!$match1){
                        ...
                        if(move_uploaded_file($_FILES['foto']['tmp_name'], $folder.$dir_img1)){
                            ...
                            $sql="UPDATE usuario SET  imgUsu='".$foto."' WHERE codUsu='".$codUsu."'";
