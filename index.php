...
<head>
  ...
  <title>
    Inicar Sesion :: <?php echo $template['nom_proyecto'];?>
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto" >
            <div class="card z-index-0" style="background-color:#1A2332;">
              <div class="card-body" style="background-color:#1A2332;">
                ...
                <form role="form text-left" id="login_php">
                  <div class="mb-3">
                  ...
                  <p class="text-center text-sm mt-3 mb-0">No tienes cuenta? <a href="register.php" class=" font-weight-bolder" style="color:#9FEF00;">Solicitalo aqui</a></p>
                  <p style="font-size:14px" class="text-center mb-0">Eres Administrador? <a href="admin.php" class=" font-weight-bolder" style="color:#9FEF00;">Iniciar Sesion</a></p>
                </form>
              </div>
            </div>
          </div>
